...
export default function Header(){
  ...
  const [isOpen, setIsOpen] = useState(false);
    ...
    return(
      ...
      <div className="flex items-center gap-4">
        ...
        <NavLink to="/">
        <img src="/src/assets/logo.png" alt="CodeBytes_logo" className="w-28 md:w-40 scale-95 transition-transform duration-300 ease-in-out hover:scale-100 cursor-pointer" />
        </NavLink>
      ...
      {theme === "dark" ? <Sun size={22} /> : <Moon size={22} />}
        ...
        {!isAuthenticate &&
          <div className="flex gap-2">
           <NavLink to="/Login">
              <button  className="btn btn-sm bg-[#ff6200] hover:opacity-80 ">Login</button>
           </NavLink>
           <NavLink to="/Signup">
              <button  className="btn btn-sm bg-[#ff6200] hover:opacity-80 ">Sign up</button>
           </NavLink>
        </div>
         }
  ...
  <NavLink to="/">
    <img src="/src/assets/logo.png" alt="CodeBytes_logo" className="w-40" />
  </NavLink>

...
// import { ExternalLink, Code2, Layers, Trophy, MessageSquare, PlaySquare, Map, Cpu, Database, Linkedin, Twitter, Github } from "lucide-react";

// export default function AboutUs() {
//   return (
//     <div className="p-6 mt-15 bg-[#121212] min-h-screen text-white">
...
//       <div className="bg-[#1f1f1f] p-6 rounded-xl mb-10 border border-[#ff6200]/30 
//       hover:scale-102 hover:shadow-[0_0_25px_#ff6200] hover:-translate-y-1 
...
//             content:
//               "Write and execute code instantly using our embedded code editor.",
//           },
//           {
//             title: "Leaderboard",
//             icon: <Trophy size={26} />,
//             content:
//               "Compete globally and climb the leaderboard to showcase your skills.",
//           },
//           {
//             title: "Discussion Forum",
//             icon: <MessageSquare size={26} />,
//             content:
//               "Ask doubts, share solutions, and connect with other coders.",
//           },
//           {
...
//           <div
//             key={index}
//             className="bg-[#1f1f1f] p-6 rounded-lg border border-[#ff6200]/20
//             hover:shadow-[0_0_20px_#ff6200] hover:-translate-y-1 hover:scale-105
...
//           target="_blank"
//           className="bg-[#1f1f1f] p-6 rounded-lg border border-[#ff6200]/20 
//           hover:shadow-[0_0_20px_#ff6200] hover:-translate-y-1 transition cursor-pointer"
//         >
//           <h3 className="text-xl font-bold mb-2 flex items-center gap-2 text-[#ff6200]">
//             <Cpu size={20} /> Frontend <ExternalLink size={18} />
//           </h3>
//           <p className="text-gray-300">React.js & TailwindCSS</p>
//         </a>
...
//           </h3>
//           <p className="text-gray-300">MongoDB Atlas</p>
//         </a>
//       </div>
...
//         <div className="bg-[#1f1f1f] p-6 rounded-2xl w-[300px] border border-[#ff6200]/30
//         hover:scale-105 text-center hover:shadow-[0_0_25px_#ff6200] hover:-translate-y-1 
//         transition cursor-pointer">

//           <img
//             src="/src/assets/Akash.jpeg"
//             className="w-32 h-32 mx-auto rounded-full mb-4 object-cover border-2 border-[#ff6200]"
//             alt="Team"
//           />
...
//             <a className="hover:text-orange-500 transition ease duration-300" href="https://www.linkedin.com/in/akash-kumar-579301286/" target="_">
//               <Linkedin />
//             </a>
//             <a className="hover:text-orange-500 transition ease duration-300" target="_" href="https://x.com/akash_rajp2922">
//               <Twitter />
//             </a>
//             <a className="hover:text-orange-500 transition ease duration-300" target="_" href="https://github.com/akashkumar919">
//               <Github />
//             </a>
//           </p>

  ...
  return (
    <div className="h-full w-full flex justify-center mt-21">
      ...
      >
        ...
        <div
          className="flex items-center bg-[#1a1a1a] border border-gray-600 rounded-lg px-3 py-2 
        ...
        {/* -------- PASSWORD FIELD -------- */}
        <label htmlFor="password" className="text-sm text-white mt-3 mb-1">
          Password
        </label>
        ...
        <p className="text-xs flex justify-center mt-4 text-gray-200">
          Don't have account?&nbsp;
          <Link to="/Signup">
            <span className="hover:underline cursor-pointer text-[#ff6200]">
              Create
            </span>
          </Link>
        </p>
